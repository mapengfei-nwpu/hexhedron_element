...
void DeltaInterplation::fluid_to_solid(Function &fluid, Function &solid)
{
...
void DeltaInterplation::solid_to_fluid(Function &fluid, Function &solid)
{
...
std::vector<double> DeltaInterplation::solid_to_fluid_raw(
	Function &fluid,
	std::vector<double> &solid_values,
